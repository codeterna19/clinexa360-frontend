    ...
    <div className="flex h-screen bg-light">
      <aside className="w-64 bg-dark text-white flex flex-col">
        <div className="p-6 border-b border-gray-800">
          ...
          <p className="text-sm text-gray-400 mt-1">Lab Assistant Portal</p>
        </div>
        
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          <Link to="/lab-assistant" className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-800 transition-colors">
            <LayoutDashboard size={20} />
            <span>Dashboard</span>
          </Link>
          <Link to="/lab-assistant/requests" className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-800 transition-colors">
            <FileText size={20} />
            <span>Lab Requests</span>
          </Link>
          <Link to="/lab-assistant/results" className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-800 transition-colors">
